...
export default class PreNBA_Grid extends Component {
  render(){
    return(
      ...
      <Grid>
        <Row>
          <PreNBA_Thumbnail name="San Diego State" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/San_Diego_State_Aztecs_logo.svg/400px-San_Diego_State_Aztecs_logo.svg.png"/>
          <PreNBA_Thumbnail name="San Diego State" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/San_Diego_State_Aztecs_logo.svg/400px-San_Diego_State_Aztecs_logo.svg.png"/>
          <PreNBA_Thumbnail name="San Diego State" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/San_Diego_State_Aztecs_logo.svg/400px-San_Diego_State_Aztecs_logo.svg.png"/>
        </Row>
      </Grid>
